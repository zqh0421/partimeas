import UseCaseSelector from "@/app/components/(archived)/output-analysis/UseCaseSelector";
import CriteriaSelector from "@/app/components/(archived)/rubric/CriteriaSelector";
import { TestCase, Criteria } from "@/app/types";
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-8">
            Select test cases and rubric criteria for evaluation. Models will be
        ...
        <div className="mt-8 bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mb-6">
            <div className="flex items-center space-x-2">
              <div
                className={`w-3 h-3 rounded-full ${
                  selectedScenarioCategory ? "bg-green-500" : "bg-gray-300"
                }`}
              ></div>
            ...
            <div className="flex items-center space-x-2">
              <div
                className={`w-3 h-3 rounded-full ${
                  selectedCriteriaId ? "bg-green-500" : "bg-gray-300"
                }`}
              ></div>
