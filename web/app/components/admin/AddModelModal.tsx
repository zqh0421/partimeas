...
const MODEL_OPTIONS = {
  openai: ["gpt-3.5-turbo", "gpt-4", "gpt-4o-mini", "gpt-4o", "o1-mini", "o1"],
  anthropic: [
...
export function AddModelModal({
  ...
  const handlePasteInput = (value: string) => {
    ...
    const names = value
      ...
      .filter(
        (name) =>
          name && PREDEFINED_MODELS[name as keyof typeof PREDEFINED_MODELS]
      );
    ...
    form.validateFields().then((values) => {
      ...
      selectedTags.forEach((tag) => {
        const predefinedData =
          PREDEFINED_MODELS[tag as keyof typeof PREDEFINED_MODELS];
        if (predefinedData) {
          onConfirm({
            name: tag,
      ...
      <Space direction="vertical" style={{ width: "100%" }} size="large">
        ...
        <div>
          ...
          <Text type="secondary" style={{ marginBottom: 16, display: "block" }}>
            ...
            <Text code copyable={{ text: "Lucy,Jack,Emma" }}>
              {" "}
              Lucy, Jack, Emma{" "}
            </Text>
          </Text>
        ...
        <div>
          ...
          >
            <Form.Item label="Model Name" name="name">
              <Input
            ...
            <Form.Item
              ...
              name="provider"
              rules={[
                { required: !!customName, message: "Please select a provider" },
              ]}
            >
              <Select
                value={provider}
            ...
            <Form.Item
              ...
              name="model"
              rules={[
                { required: !!customName, message: "Please select a model" },
              ]}
            >
              <Select
                value={model}
