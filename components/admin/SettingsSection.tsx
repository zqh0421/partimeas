    ...
    <div className="space-y-8">
      <div className="space-y-6">
        <div>
          ...
          <Text type="secondary">
            Configure global settings including model selection for creating assistants
          </Text>
        </div>
        ...
        <Card title="Model Configuration" className="shadow-sm">
          <Space direction="vertical" style={{ width: '100%' }} size="large">
            <Text>
              Configure which models are available for creating assistants. These models will be used across both output generation and evaluation tasks.
            </Text>
