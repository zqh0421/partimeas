...
export default function CategoryManager({ categories, onCategoriesChange }: CategoryManagerProps) {
  ...
  const handleSubCriteriaChange = (categoryId: string, subCriteriaId: string, field: keyof SubCriteria, value: string) => {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-medium text-gray-900">Categories & Sub Criteria</h3>
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {category.subCriteria.map((subCriteria) => (
                          <div key={subCriteria.id} className="border border-gray-200 rounded p-3 bg-gray-50">
                            <div className="flex items-center justify-between mb-2">
                              <h5 className="font-medium text-gray-900">Sub Criteria</h5>
                              <button
                                onClick={() => handleRemoveSubCriteria(category.id, subCriteria.id)}
                            ...
                            <div className="space-y-2">
                              <input
                                ...
                                onChange={(e) => handleSubCriteriaChange(category.id, subCriteria.id, 'name', e.target.value)}
                              />
                              ...
                              <textarea
                                ...
                                onChange={(e) => handleSubCriteriaChange(category.id, subCriteria.id, 'description', e.target.value)}
                              />
                            </div>
                          </div>
                        ))}
