...
import { RubricVersion as BaseRubricVersion, RubricItem, TestCase } from '@/types';
...
export default function RubricVersioning({ rubricData, setRubricData }: RubricVersioningProps) {
  const [versions, setVersions] = useState<RubricVersion[]>(rubricData.versions || []);
  const [selectedVersion, setSelectedVersion] = useState<RubricVersion | null>(null);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Rubric Versioning</h2>
        <p className="text-gray-600 mb-6">
          Save and manage different versions of your rubric for comparison and rollback.
        </p>
      </div>
              ...
              {versions.map((version) => (
                ...
                >
                  ...
                  <div className="text-xs text-gray-500 space-y-1">
                    ...
                    <div>Items: {version.rubricItems?.length || 0} criteria</div>
