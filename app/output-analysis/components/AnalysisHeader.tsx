          ...
          <div className="flex space-x-4">
            <div className={`flex items-center space-x-2 ${
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                currentStep === 'sync' ? 'bg-blue-600 text-white' : 'bg-gray-200'
              }`}>
                1
              </div>
            ...
            <div className={`flex items-center space-x-2 ${
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                currentStep === 'run' ? 'bg-blue-600 text-white' : 'bg-gray-200'
              }`}>
                2
              </div>
            ...
            <div className={`flex items-center space-x-2 ${
              ...
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                currentStep === 'outcomes' ? 'bg-blue-600 text-white' : 'bg-gray-200'
              }`}>
                3
              </div>
