import UseCaseSelector from '@/components/output/UseCaseSelector';
import CriteriaSelector from '@/components/output/CriteriaSelector';
import { TestCase, Criteria } from '../types';
